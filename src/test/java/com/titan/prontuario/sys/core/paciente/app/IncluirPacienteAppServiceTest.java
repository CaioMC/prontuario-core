...
@Rollback
@ActiveProfiles("it")
class IncluirPacienteAppServiceTest {

	@InjectMocks
	private IncluirPacienteAppService incluirPacienteAppService;

	@Mock
	private PacienteDomainRepository repository;

	@Test
	void testIncluirPacienteSuccess() {
		...
		assertDoesNotThrow(() -> this.incluirPacienteAppService.handle(incluirPacienteCommand));
	}
}
