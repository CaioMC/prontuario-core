...
@Rollback
@ActiveProfiles("it")
class UpdatePacienteAppServiceTest {

	@InjectMocks
	private UpdatePacienteAppService updatePacienteAppService;
	...
	void testUpdatePacientePacienteSuccess() {
		...
		assertDoesNotThrow(() -> this.updatePacienteAppService.handle(updatePacienteCommand));
	}
}
